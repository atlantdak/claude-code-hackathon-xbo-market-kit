...
- [x] Updated `docs/metrics/tasks.json` with Task 5 (plugin MVP)
- [x] Updated README.md dashboard metrics, Gantt timeline, feature table, task details
...
- [ ] Per-project cost tracking (ccusage can't filter by project)
